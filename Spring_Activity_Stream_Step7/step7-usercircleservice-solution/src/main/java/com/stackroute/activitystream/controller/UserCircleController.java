...
public class UserCircleController {
	...
	*/
	...
	public ResponseEntity<?> addUserToCircle(@PathVariable("username") String username,
		...
		try {
			...
			return new ResponseEntity<String>("Error occured while adding user to circle",
	...
	*/
	...
	public ResponseEntity<?> getSubscribeCircleByUser(@PathVariable("username") String username) {

		List<String> list = userCircleService.getMyCircles(username);
