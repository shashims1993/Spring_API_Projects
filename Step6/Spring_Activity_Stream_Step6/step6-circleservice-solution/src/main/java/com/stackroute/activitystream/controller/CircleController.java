...
public class CircleController {
	 ...
	 */
	@PostMapping
	public ResponseEntity<?> createCircle(@RequestBody Circle circle, HttpSession session) {

		Circle circleObj = circleService.get(circle.getCircleName());
		if (circleObj != null) {
	...
	public ResponseEntity<?> getAllCircleNameBysearchString(@PathVariable("searchString") String searchString,
			HttpSession session) {

		List<Circle> list = circleService.getAllCircles(searchString);
